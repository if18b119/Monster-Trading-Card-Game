...
REM Create User
curl -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"Username\":\"kienboec\", \"Password\":\"daniel\", \"Role\":\"player\", \"Name\":\"Daniel Kienboec\", \"Email\":\"kienboec@gmail.com\"}"
echo.
curl -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"Username\":\"altenhof\", \"Password\":\"markus\", \"Role\":\"player\", \"Name\":\"Markus Altenhof\", \"Email\":\"markus@gmail.com\"}"
echo.
curl -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"Username\":\"admin\",    \"Password\":\"istrator\", \"Role\":\"admin\", \"Name\":\"Admin Aller Admins\", \"Email\":\"admin@gmail.com\"}"
echo.
